...
synced server-side. If your app already has a working Runtime v2 endpoint,
follow [Connect an Existing App to Hosted Intelligence](/premium/existing-app-hosted-intelligence)
first. <SignupLink surface="docs_drawer">Get a free developer account</SignupLink>
to create a hosted project.

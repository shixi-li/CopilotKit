...
To connect an app that already has a working Runtime v2 endpoint, follow [Connect an Existing App to Hosted Intelligence](/premium/existing-app-hosted-intelligence).
